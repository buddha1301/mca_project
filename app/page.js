    ...
    <section className="bg-white dark:bg-gray-900">
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div className="mr-auto place-self-center lg:col-span-7">
                ...
                <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">All votes casted for the  <strong className="font-semibold">ELDERLY VOTERS ONLY (above 75 years)</strong> of Sikkim  for the  year 2024  can be done via this portal.Click the New pooling booth if your booth is not registered with id and password button if you are a new pooling booth or click the Registered Pooling Booth button if you have already registered </p>
